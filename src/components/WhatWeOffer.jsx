    ...
    <section className="text-center flex flex-col text-black w-full p-[2%]">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between p-[20px] md:p-[5%] bg-[hsla(0,_0%,_0%,_0.2)] my-[30px]">
        ...
        >
          ...
          <p>
            Transform your personal life with our comprehensive development
        ...
        <motion.img
          ...
          className="w-full md:w-[45%] rounded-[5px]"
          src="/images/pgrowthms.webp"
          alt="personalgrowthmastery"
        />
      </div>
      <div className="flex flex-col-reverse md:flex-row items-center justify-between p-[20px] md:p-[5%] bg-[hsla(0,_0%,_0%,_0.2)] my-[30px]">
        <motion.div
        ...
        >
          ...
          <p>
            Master your financial future with strategies designed for
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between p-[20px] md:p-[5%] bg-[hsla(0,_0%,_0%,_0.2)] my-[30px]">
        ...
        >
          ...
          <p>
            Accelerate your professional growth with our proven career
