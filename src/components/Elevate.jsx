    ...
    <section className="text-white w-full flex flex-col  items-center text-center">
      <div className="servicehero flex flex-col items-center justify-center">
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-bold mt-[10px]"
        >
        ...
        <motion.p
          ...
          className="text-xl md:text-3xl my-[30px] w-[70%]"
        >
          Unlock new heights in your personal and professional journey. Our
          expert consulting services are designed to help you refine your
          strategies, overcome challenges, and achieve your goals. Elevate your
          potential with tailored solutions that drive success.
        </motion.p>
      </div>
      <div className="elegrid">
        ...
        >
          ...
          <p className="text-xl mt-[20px] w-[80%]">
            Empower yourself to thrive in all aspects of life with our
            comprehensive personal development services.
          </p>
          <button
            onClick={() => {
              setShow1(!show1);
            }}
            className="flex items-center w-[90%] justify-between p-[2%] my-[20px] text-[#9333EA] font-bold text-xl"
          >
            View Services <FiArrowRight />
          </button>
          {show1 && (
            <div className="flex flex-col w-[100%] p-[10px] mt-[-30px] mb-[20px]">
              {servicethings[0].map((item, index) => {
                return (
                  <p
                    className="flex items-center text-start my-[5px]"
                    key={index}
                  >
                    <IoMdCheckmarkCircleOutline className="w-[30px] h-[30px] text-green-400 mb-[3%] mr-[5px]" />{" "}
                    {item}
                  </p>
                );
              })}
        ...
        >
          ...
          <p className="text-xl mt-[20px] w-[80%]">
            Build a secure financial future with our expert-designed services
        ...
        >
          ...
          <p className="text-xl mt-[20px] w-[80%]">
            Reach new career heights with our cutting-edge professional
            development programs and personalized coaching.
          </p>
          <button
            onClick={() => {
              setShow3(!show3);
        ...
        >
          ...
          <p className="text-xl mt-[20px] w-[80%]">
            Take your enterprise to the next level with our comprehensive
            business support services and expert consultations.
          </p>
          <button
            onClick={() => {
              setShow4(!show4);
