  ...
  return (
    <section className="text-white w-full flex flex-col  items-center text-center mt-[50px]">
      <motion.h1
        ...
        className="text-4xl md:text-6xl font-bold mt-[10px] mb-[50px] text-[#C084FC]"
      >
      ...
      >
        <p className="text-2xl">
          At EnhanceSphere, we are committed to your success. We believe in
          building lasting relationships with our clients, supporting you every
          step of the way on your journey to personal, financial, and
